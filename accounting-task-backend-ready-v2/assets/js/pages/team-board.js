...
function renderTeamBoard(root){
 renderAsyncPage(root,'teamBoard','CROSS-TEAM WORKSPACE','Team Board',()=>renderTeamBoardView(root));
}
...
function teamBoardView(tasks){return renderBoardColumns(tasks,{withLoadMore:true,scrollLabel:'เลื่อน Team Board ในแนวนอน'})}
